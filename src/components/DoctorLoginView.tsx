...
export default function DoctorLoginView({
  ...
  const wording = {
    en: {
      ...
      passwordHint: 'For demo: any password works',
    ...
    kh: {
      ...
      passwordHint: 'សម្រាប់ការសាកល្បង៖ ពាក្យសម្ងាត់ណាមួយក៏បាន',
        ...
        {!selectedRole ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" id="doctor-login-form">
              ...
              <button
                type="submit"
                className="w-full py-3.5 bg-gradient-to-r from-[#2F6F8F] to-[#4A8BAF] hover:from-[#1d5572] hover:to-[#3d7a9e] active:scale-[0.99] text-white font-black rounded-xl text-sm transition-all cursor-pointer shadow-3xs flex items-center justify-center space-x-2 mt-2"
